...
func TestParseXpubDescriptors(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:   "sh([5c9e228d/99'/0'/0']xpub/{0,123,4431}/*)",
			xpub:   "sh([5c9e228d/99'/0'/0']xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ/{122,123,4431}/*)",
			parser: btcMainParser,
			want: &bchain.XpubDescriptor{
				XpubDescriptor: "sh([5c9e228d/99'/0'/0']xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ/{122,123,4431}/*)",
		...
		{
			name:   "sh(xpub)",
			xpub:   "sh(xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ)",
			parser: btcMainParser,
			want: &bchain.XpubDescriptor{
				XpubDescriptor: "sh(xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ)",
				Xpub:           "xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ",
				Type:           bchain.P2SH,
				Bip:            "49",
				ChangeIndexes:  []uint32{0, 1},
		...
		{
			name:   "wsh(xpub)",
			xpub:   "wsh(xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ)",
			parser: btcMainParser,
			want: &bchain.XpubDescriptor{
				XpubDescriptor: "wsh(xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ)",
				Xpub:           "xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ",
				Type:           bchain.P2WSH,
				Bip:            "84",
				ChangeIndexes:  []uint32{0, 1},
		...
		{
			name:    "sh([5c9e228d/99'/0'/0']xpub/{0,123,4431}/1) error - * in index is mandatory",
			xpub:    "sh([5c9e228d/99'/0'/0']xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ/{122,123,4431}/1)",
			parser:  btcMainParser,
			wantErr: true,
		},
		{
			name:    "sh([5c9e228d/99'/0'/0']xpub/{0,123,4431}/1) error - path too long",
			xpub:    "sh([5c9e228d/99'/0'/0']xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ/{122,123,4431}/1/*)",
			parser:  btcMainParser,
			wantErr: true,
		},
